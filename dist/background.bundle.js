...
var BrowserTracing = /** @class */ (function () {
    function BrowserTracing(_options) {
        ...
        this._metrics = new _metrics__WEBPACK_IMPORTED_MODULE_4__.MetricsInstrumentation((0,tslib__WEBPACK_IMPORTED_MODULE_0__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_0__.__assign)({}, _metrics__WEBPACK_IMPORTED_MODULE_4__.DEFAULT_METRICS_INSTR_OPTIONS), this.options._metricOptions));
    }
    /**
     * @inheritDoc
     */
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DEFAULT_METRICS_INSTR_OPTIONS": () => (/* binding */ DEFAULT_METRICS_INSTR_OPTIONS),
...
var Api = /*#__PURE__*/function () {
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Api, [{
    ...
    value: function (_fetch) {
      ...
      return chrome.storage.sync.get(["headers"]).then(function (_ref) {
        var _ref$headers = _ref.headers,
            headers = _ref$headers === void 0 ? [] : _ref$headers;
        return fetch("".concat(_this.baseURL).concat(id, ".json?tweet_mode=extended"), {
          credentials: "include",
          headers: new Headers((0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(headers.map(function (_) {
            return [_.name, _.value];
          })))
        }).then(function (response) {
          return response.json();
        }).then(function (response) {
          var tweet = response.globalObjects.tweets[id];
          ...
          var videos = media.video_info.variants.filter(function (_) {
            return _.content_type === "video/mp4";
          });
          var orderVideosByBitrate = videos.sort(function (a, b) {
...
/* harmony import */ var _sentry_browser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @sentry/browser */ "./node_modules/@sentry/minimal/esm/index.js");
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api */ "./src/background/api.js");
...
_sentry_browser__WEBPACK_IMPORTED_MODULE_2__.init({
  ...
  integrations: [new _sentry_tracing__WEBPACK_IMPORTED_MODULE_0__.Integrations.BrowserTracing({
    routingInstrumentation: function routingInstrumentation() {}
  })],
...
chrome.webRequest.onSendHeaders.addListener(function (details) {
  var headers = details.requestHeaders.filter(function (header) {
    return ["x-guest-token", "x-csrf-token", "authorization"].indexOf(header.name) > -1;
  });
...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
  if (request.action === "getVideoUrl") {
    api.fetch(request.id).then(function (response) {
      sendResponse({
        status: true,
        url: response.url,
        name: response.name
      ...
      _sentry_browser__WEBPACK_IMPORTED_MODULE_3__.captureException(error);
      sendResponse({
        status: false
      });
    });
